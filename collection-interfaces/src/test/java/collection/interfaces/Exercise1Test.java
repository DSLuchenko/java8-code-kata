...
public class Exercise1Test extends ClassicOnlineStore {
    ...
    public void whoHaveNoEInYourName() {
         ...
         */
        Predicate<String> predicate = (str) -> str.contains("e");
    ...
    public void replaceTheElements() {
         ...
         */
        UnaryOperator<String> unaryOperator = (str) -> String.format("(%s)",str);
    ...
    public void createParallelStream() {
        ...
        /*
        String[] tmpStringArr = new String[nameList.size()];
        Stream<String> nameParallelStream = Stream.of(nameList.toArray(tmpStringArr)).parallel();
         */
