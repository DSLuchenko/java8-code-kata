...
public class Exercise4Test extends ClassicOnlineStore {
	...
	public void isThereAnyoneOlderThan40() {
		 ...
		 */
		boolean olderThan40Exists = customerList.stream().anyMatch(t -> t.getAge() > 40);
	...
	public void isEverybodyOlderThan20() {
		 ...
		 */
		boolean allOlderThan20 = customerList.stream().allMatch(t -> t.getAge() > 20);
	...
	public void everyoneWantsSomething() {
		 ...
		 */
		boolean everyoneWantsSomething = customerList.stream().noneMatch(t -> t.getWantToBuy().size() == 0);
